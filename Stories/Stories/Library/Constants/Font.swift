...
struct Font {
  ...
  struct Story {
    static let title = UIFont(name: Brandon.bold, size: 32)!
  ...
  struct Finale {
    static let title = UIFont(name: Monaco.regular, size: 24)!
    static let button = UIFont(name: Brandon.bold, size: 25)!
  }
}
